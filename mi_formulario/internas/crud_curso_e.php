...
<?php
	...
	while ($registros=mysql_fetch_array($reg)) {
		...
		echo "<td><a href='crud_curso/editar.php?id=$registros[0]'>Modificar</a></td>";
		echo "<td><a href='crud_curso/eliminar.php?id=$registros[0]'>Eliminar</a></td>";
		echo "</tr>";
		}
	echo "</table>";	
?>
<button><a href='crud_curso/crear.php'>Crear</a></button>
